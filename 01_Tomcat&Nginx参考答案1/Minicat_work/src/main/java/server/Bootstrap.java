            ...
            for (int i = 0; i < selectNodes.size(); i++) {
                ...
                for (Context context : host.getContexts()) {
                    ...
                    for (Wrapper wrapper : context.getWrappers()) {
                        System.out.println("wrapper:"+wrapper.getUrlPattern()+"     "+wrapper.getServlet());
                    }
    ...
    public List<Wrapper> loadWebXml(String webXmlPath) throws FileNotFoundException {
        ...
        try {
            ...
            for (int i = 0; i < selectNodes.size(); i++) {
               ...
               // System.out.println("webXmlPath:"+webXmlPath);
                //System.out.println("ceshi:"+webXmlPath.replace("web.xml", ""));
